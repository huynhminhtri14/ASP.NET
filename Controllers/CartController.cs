...
namespace HuynhMinhTri_2122110256.Controllers
    {
        ...
        {
            minhtriEntities objminhtriEntitiesEntities = new minhtriEntities();
            ...
            public ActionResult AddToCart(int id, int quantity)
            {
                if (Session["cart"] == null)
                {
                    ...
                    cart.Add(new CartModel { Product = objminhtriEntitiesEntities.Products.Find(id), Quantity = quantity });
                    Session["cart"] = cart;
                    Session["count"] = 1;
                }
                else
